WebVoiceProcessor = (function () {
    ...
    let start = function (engines, downsamplerScript, errorCallback, callback) {
        if (!downsampler) {
            navigator.mediaDevices.getUserMedia({video: false,
                ...
                .then(stream => {
                    ...
                    if(callback) callback({audioContext: audioContext, audioSource: audioSource, node: node, downsampler: downsampler})
                })
                .catch(errorCallback);
        }
